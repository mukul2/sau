...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
   ...
   return AnnotatedRegion<SystemUiOverlayStyle>(
     ...
     backgroundColor: Colors.white,body:ListView(shrinkWrap: true,
      children: [
                ...
                return   Column(
                  children: [
                    ...
                    GridView(padding: EdgeInsets.zero,shrinkWrap: true,physics: NeverScrollableScrollPhysics(),
                        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(childAspectRatio:1,crossAxisCount: 2, mainAxisSpacing: 16),
                            ...
                            child: ClipRRect(borderRadius: BorderRadius.circular(4),
                              ...
                              child: true?Stack(
                                ...
                                children: [
                                  ...
                                  Align(alignment: Alignment.bottomCenter, child: Container(height: 40,child: ClipRect(child:  BackdropFilter( filter:  ImageFilter.blur(sigmaX: 10.0, sigmaY: 10.0),child: Center(child: Text(e.get("name"),textAlign: TextAlign.center,)))))),
                                ],
                              ),),
                          ),
                        )).toList()
