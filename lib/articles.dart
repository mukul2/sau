...
class _ArticlesState extends State<Articles> {
  ...
  Widget build(BuildContext context) {
    Stream<QuerySnapshot> st = widget.parent==""?FirebaseFirestore.instance.collection(appDatabsePrefix+"article").where("parent", isEqualTo:widget.parent ).snapshots():FirebaseFirestore.instance.collection(appDatabsePrefix+"article").where("parent", isEqualTo:widget.parent ).snapshots();
