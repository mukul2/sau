  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
     ...
     backgroundColor: Colors.grey.withOpacity(0.1),
      appBar: PreferredSize(preferredSize: AppBar().preferredSize,child: Align(alignment: Alignment.topCenter,child: ClipRect(
                  ...
                  child: Stack(children: [
                    ...
                    widget.id.get("photo2").toString().length==0? Container(height: 0,width: 0,) :  Align(alignment: Alignment.center ,child: Column(mainAxisAlignment: MainAxisAlignment.end,crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        ...
                        Text( widget.id.get("name",),style: TextStyle(fontWeight: FontWeight.bold,fontSize: MediaQuery.of(context).size.width * 0.045),),
                ...
                child: Container(
                  ...
                  child:Column(
                    children: [
                      ...
                      FutureBuilder<QuerySnapshot>(
                          future: FirebaseFirestore.instance.collection("sau_datatype").orderBy("order").limit(8). get() ,  // a previously-obtained Future<String> or null
                          builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshotC) {

                            if (snapshotC.hasData &&  snapshotC.data!.docs.length>0) {
                              return   ListView.separated(shrinkWrap: true,
                              itemCount: snapshotC.data!.docs.length-4,
                              itemBuilder: (BuildContext context, int index) {
                              Map<String,dynamic> m = snapshotC.data!.docs[index+4].data() as Map<String,dynamic>;
                              return Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    wi1(snapshotC.data!.docs[index+4]),
                ...
                child: Container(
                  ...
                  child:Column(
                    children: [
                      Container(color: Colors.blue,child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Center(child: Text("ADDITIONAL INFORMATION")),
                      )),
                      FutureBuilder<QuerySnapshot>(
                          future: FirebaseFirestore.instance.collection("sau_datatype").orderBy("order").limit(12). get() ,  // a previously-obtained Future<String> or null
                          builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshotC) {
                ...
                child: Container(
                  ...
                  child:Column(
                    children: [
                      Container(color: Colors.blue,child: Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Center(child: Text("OTHERS INFORMATION")),
                      )),
                      FutureBuilder<QuerySnapshot>(
                          ...
                          builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshotC) {
                            ...
                            if (snapshotC.hasData &&  snapshotC.data!.docs.length>0) {
                              return   ListView.separated(shrinkWrap: true,
                                itemCount: snapshotC.data!.docs.length-12,
                                itemBuilder: (BuildContext context, int index) {
                                  Map<String,dynamic> m = snapshotC.data!.docs[index+12].data() as Map<String,dynamic>;
                                  return Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
