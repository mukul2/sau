                  ...
                  return InkWell( onTap: (){
                    ...
                    child: Padding(
                      ...
                      child: Container(decoration: BoxDecoration(color: bar.selectedMenu==index?Colors.grey.withOpacity(0.2):Colors.transparent,borderRadius: BorderRadius.circular(3)), child: Padding(
                        ...
                        child: Row(
                          children: [
                            Container(margin: EdgeInsets.symmetric(horizontal: 6),height: 8,width: 8,decoration: BoxDecoration(shape: BoxShape.circle,color: bar.selectedMenu == index?Colors.grey:Colors.transparent),),
